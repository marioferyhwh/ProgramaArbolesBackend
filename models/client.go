...
type Client struct {
	...
	Document        uint8  `json:"document_number,omitempty" gorm:"type:NUMERIC(11)"`
	...
	CodBusinessType uint8  `json:"id_type_business,omit" gorm:"type:SMALLINT; NOT NULL;default:0"`
